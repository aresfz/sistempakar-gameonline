...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4" style="width: 50%;">
        <div class="card-header py-3">
            ...
            <div class="card-body">
                <?php echo form_open_multipart('Penyakit/edit'); ?>
                <input type="hidden" name="idPenyakit" value="<?php echo $penyakit->idPenyakit; ?>">
                <div class="form-group row">
                    <div class="col-sm-3 col-form-label">Kode Penyakit</div>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="kdPenyakit" id="Kode"
                            value="<?php echo $penyakit->kdPenyakit; ?>">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="namaPenyakit" id="Nama"
                            value="<?php echo $penyakit->namaPenyakit; ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-3 col-form-label">Detail</div>
                    <div class="col-sm-9">
                        <textarea name="detail" id="edit" cols="30" rows="10"><?= $penyakit->detail; ?></textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-3 col-form-label">Solusi</div>
                    <div class="col-sm-9">
                        <textarea name="solusi" id="edit" cols="30" rows="10"><?= $penyakit->saran; ?></textarea>
                    </div>
                </div>
